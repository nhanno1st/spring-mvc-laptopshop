package vn.nhan.laptopshop.controller.admin;
...
import vn.nhan.laptopshop.service.UploadService;
...
public class UserController {
    ...
    public String createUserPage(Model model,
            @ModelAttribute("newUser") @Valid User nhan,
            BindingResult newUserBindingResult,
            @RequestParam("nhanFile") MultipartFile file) {
